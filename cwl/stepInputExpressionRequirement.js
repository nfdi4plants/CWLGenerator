...
exports.StepInputExpressionRequirement = void 0;
 ...
 *
 */
class StepInputExpressionRequirement extends internal_1.Saveable {
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let class_;
            try {
                class_ = yield (0, internal_1.loadField)(_doc.class, internal_1.LoaderInstances.uriStepInputExpressionRequirement_classLoaderFalseTrueNone, baseuri, loadingOptions);
            }
            catch (e) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'StepInputExpressionRequirement'", __errors);
            }
...
exports.StepInputExpressionRequirement = StepInputExpressionRequirement;
StepInputExpressionRequirement.attr = new Set(['class']);
//# sourceMappingURL=stepInputExpressionRequirement.js.map