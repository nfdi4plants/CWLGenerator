    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const [key, value] of Object.entries(_doc)) {
                if (!InputEnumSchema.attr.has(key)) {
                    if (key.includes(':')) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'InputEnumSchema'", __errors);
            }
...
exports.InputEnumSchema = InputEnumSchema;
InputEnumSchema.attr = new Set(['symbols', 'type', 'label', 'doc', 'name']);
//# sourceMappingURL=inputEnumSchema.js.map