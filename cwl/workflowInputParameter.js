    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ('inputBinding' in _doc) {
                try {
                    inputBinding = yield (0, internal_1.loadField)(_doc.inputBinding, internal_1.LoaderInstances.unionOfundefinedtypeOrInputBindingLoader, baseuri, loadingOptions);
                }
                catch (e) {
                    if (e instanceof internal_1.ValidationException) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'WorkflowInputParameter'", __errors);
            }
...
exports.WorkflowInputParameter = WorkflowInputParameter;
WorkflowInputParameter.attr = new Set(['label', 'secondaryFiles', 'streamable', 'doc', 'id', 'format', 'loadContents', 'loadListing', 'default', 'type', 'inputBinding']);
//# sourceMappingURL=workflowInputParameter.js.map