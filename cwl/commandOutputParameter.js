...
exports.CommandOutputParameter = void 0;
 ...
 */
class CommandOutputParameter extends internal_1.Saveable {
     ...
     * @returns                               An instance of {@link CommandOutputParameter }
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let type;
            try {
                type = yield (0, internal_1.loadField)(_doc.type, internal_1.LoaderInstances., baseuri, loadingOptions);
            }
            catch (e) {
                if (e instanceof internal_1.ValidationException) {
            ...
            for (const [key, value] of Object.entries(_doc)) {
                if (!CommandOutputParameter.attr.has(key)) {
                    if (key.includes(':')) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'CommandOutputParameter'", __errors);
            }
    ...
    save(top = false, baseUrl = '', relativeUris = true) {
        ...
        if (this.outputBinding != null) {
            r.outputBinding = (0, internal_1.save)(this.outputBinding, false, this.id, relativeUris);
        }
        if (top) {
...
CommandOutputParameter.attr = new Set(['label', 'secondaryFiles', 'streamable', 'doc', 'id', 'format', 'type', 'outputBinding']);
//# sourceMappingURL=commandOutputParameter.js.map