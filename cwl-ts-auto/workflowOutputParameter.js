...
exports.WorkflowOutputParameter = void 0;
 ...
 *
 */
class WorkflowOutputParameter extends internal_1.Saveable {
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ('outputSource' in _doc) {
                try {
                    outputSource = yield (0, internal_1.loadField)(_doc.outputSource, internal_1.LoaderInstances.uriunionOfundefinedtypeOrstrtypeOrarrayOfstrtypeFalseFalse0, baseuri, loadingOptions);
                }
                catch (e) {
                    if (e instanceof internal_1.ValidationException) {
                        __errors.push(new internal_1.ValidationException('the `outputSource` field is not valid because: ', [e]));
                    }
                    else {
                        throw e;
                    }
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'WorkflowOutputParameter'", __errors);
            }
    ...
    save(top = false, baseUrl = '', relativeUris = true) {
        ...
        if (this.outputSource != null) {
            const u = (0, internal_1.saveRelativeUri)(this.outputSource, this.id, false, relativeUris, 0);
            if (u != null) {
                r.outputSource = u;
            }
        }
...
exports.WorkflowOutputParameter = WorkflowOutputParameter;
WorkflowOutputParameter.attr = new Set(['label', 'secondaryFiles', 'streamable', 'doc', 'id', 'format', 'outputSource', 'linkMerge', 'pickValue', 'type']);
//# sourceMappingURL=workflowOutputParameter.js.map