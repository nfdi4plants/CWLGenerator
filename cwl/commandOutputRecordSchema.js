...
class CommandOutputRecordSchema extends internal_1.Saveable {
    ...
    /**
     * Used to construct instances of {@link CommandOutputRecordSchema }.
     *
     * @param __doc                           Document fragment to load this record object from.
     * @param baseuri                         Base URI to generate child document IDs against.
     * @param loadingOptions                  Context for loading URIs and populating objects.
     * @param docRoot                         ID at this position in the document (if available)
     * @returns                               An instance of {@link CommandOutputRecordSchema }
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ('fields' in _doc) {
                try {
                    fields = yield (0, internal_1.loadField)(_doc.fields, internal_1.LoaderInstances.idmapfieldsunionOfundefinedtypeOrarrayOfCommandOutputRecordFieldLoader, baseuri, loadingOptions);
                }
                catch (e) {
                    if (e instanceof internal_1.ValidationException) {
            ...
            for (const [key, value] of Object.entries(_doc)) {
                if (!CommandOutputRecordSchema.attr.has(key)) {
                    if (key.includes(':')) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'CommandOutputRecordSchema'", __errors);
            }
            const schema = new CommandOutputRecordSchema({
...
exports.CommandOutputRecordSchema = CommandOutputRecordSchema;
CommandOutputRecordSchema.attr = new Set(['fields', 'type', 'label', 'doc', 'name']);
//# sourceMappingURL=commandOutputRecordSchema.js.map