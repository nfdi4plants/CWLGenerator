...
class InputRecordSchema extends internal_1.Saveable {
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ('fields' in _doc) {
                try {
                    fields = yield (0, internal_1.loadField)(_doc.fields, internal_1.LoaderInstances.idmapfieldsunionOfundefinedtypeOrarrayOfInputRecordFieldLoader, baseuri, loadingOptions);
                }
                catch (e) {
                    if (e instanceof internal_1.ValidationException) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'InputRecordSchema'", __errors);
            }
...
exports.InputRecordSchema = InputRecordSchema;
InputRecordSchema.attr = new Set(['fields', 'type', 'label', 'doc', 'name']);
//# sourceMappingURL=inputRecordSchema.js.map