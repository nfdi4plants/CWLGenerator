...
class OutputArraySchema extends internal_1.Saveable {
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let items;
            try {
                items = yield (0, internal_1.loadField)(_doc.items, internal_1.LoaderInstances.typedslunionOfCWLTypeLoaderOrOutputRecordSchemaLoaderOrOutputEnumSchemaLoaderOrOutputArraySchemaLoaderOrstrtypeOrarrayOfunionOfCWLTypeLoaderOrOutputRecordSchemaLoaderOrOutputEnumSchemaLoaderOrOutputArraySchemaLoaderOrstrtype2, baseuri, loadingOptions);
            }
            catch (e) {
                if (e instanceof internal_1.ValidationException) {
            ...
            for (const [key, value] of Object.entries(_doc)) {
                if (!OutputArraySchema.attr.has(key)) {
                    if (key.includes(':')) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'OutputArraySchema'", __errors);
            }
            const schema = new OutputArraySchema({
...
exports.OutputArraySchema = OutputArraySchema;
OutputArraySchema.attr = new Set(['items', 'type', 'label', 'doc', 'name']);
//# sourceMappingURL=outputArraySchema.js.map