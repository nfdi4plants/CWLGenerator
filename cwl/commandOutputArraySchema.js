...
class CommandOutputArraySchema extends internal_1.Saveable {
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let items;
            try {
                items = yield (0, internal_1.loadField)(_doc.items, internal_1.LoaderInstances., baseuri, loadingOptions);
            }
            catch (e) {
                if (e instanceof internal_1.ValidationException) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'CommandOutputArraySchema'", __errors);
            }
...
exports.CommandOutputArraySchema = CommandOutputArraySchema;
CommandOutputArraySchema.attr = new Set(['items', 'type', 'label', 'doc', 'name']);
//# sourceMappingURL=commandOutputArraySchema.js.map