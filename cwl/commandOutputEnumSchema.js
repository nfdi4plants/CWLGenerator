...
class CommandOutputEnumSchema extends internal_1.Saveable {
     ...
     * @returns                               An instance of {@link CommandOutputEnumSchema }
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const [key, value] of Object.entries(_doc)) {
                if (!CommandOutputEnumSchema.attr.has(key)) {
                    if (key.includes(':')) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'CommandOutputEnumSchema'", __errors);
            }
    ...
    save(top = false, baseUrl = '', relativeUris = true) {
        ...
        if (this.symbols != null) {
            const u = (0, internal_1.saveRelativeUri)(this.symbols, this.name, true, relativeUris, undefined);
            if (u != null) {
                r.symbols = u;
            }
        }
...
exports.CommandOutputEnumSchema = CommandOutputEnumSchema;
CommandOutputEnumSchema.attr = new Set(['symbols', 'type', 'label', 'doc', 'name']);
//# sourceMappingURL=commandOutputEnumSchema.js.map