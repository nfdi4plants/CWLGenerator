...
exports.SoftwareRequirement = void 0;
 ...
 *
 */
class SoftwareRequirement extends internal_1.Saveable {
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let class_;
            try {
                class_ = yield (0, internal_1.loadField)(_doc.class, internal_1.LoaderInstances.uriSoftwareRequirement_classLoaderFalseTrueNone, baseuri, loadingOptions);
            }
            catch (e) {
            ...
            let packages;
            try {
                packages = yield (0, internal_1.loadField)(_doc.packages, internal_1.LoaderInstances.idmappackagesarrayOfSoftwarePackageLoader, baseuri, loadingOptions);
            }
            catch (e) {
                if (e instanceof internal_1.ValidationException) {
                    __errors.push(new internal_1.ValidationException('the `packages` field is not valid because: ', [e]));
                }
                else {
                    throw e;
                }
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'SoftwareRequirement'", __errors);
            }
    ...
    save(top = false, baseUrl = '', relativeUris = true) {
        ...
        if (this.packages != null) {
            r.packages = (0, internal_1.save)(this.packages, false, baseUrl, relativeUris);
        }
        if (top) {
...
exports.SoftwareRequirement = SoftwareRequirement;
SoftwareRequirement.attr = new Set(['class', 'packages']);
//# sourceMappingURL=softwareRequirement.js.map