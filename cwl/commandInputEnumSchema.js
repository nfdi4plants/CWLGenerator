    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const [key, value] of Object.entries(_doc)) {
                if (!CommandInputEnumSchema.attr.has(key)) {
                    if (key.includes(':')) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'CommandInputEnumSchema'", __errors);
            }
...
exports.CommandInputEnumSchema = CommandInputEnumSchema;
CommandInputEnumSchema.attr = new Set(['symbols', 'type', 'label', 'doc', 'name', 'inputBinding']);
//# sourceMappingURL=commandInputEnumSchema.js.map