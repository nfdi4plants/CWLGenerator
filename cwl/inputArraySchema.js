...
class InputArraySchema extends internal_1.Saveable {
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let items;
            try {
                items = yield (0, internal_1.loadField)(_doc.items, internal_1.LoaderInstances.typedslunionOfCWLTypeLoaderOrInputRecordSchemaLoaderOrInputEnumSchemaLoaderOrInputArraySchemaLoaderOrstrtypeOrarrayOfunionOfCWLTypeLoaderOrInputRecordSchemaLoaderOrInputEnumSchemaLoaderOrInputArraySchemaLoaderOrstrtype2, baseuri, loadingOptions);
            }
            catch (e) {
                if (e instanceof internal_1.ValidationException) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'InputArraySchema'", __errors);
            }
...
exports.InputArraySchema = InputArraySchema;
InputArraySchema.attr = new Set(['items', 'type', 'label', 'doc', 'name']);
//# sourceMappingURL=inputArraySchema.js.map