 ...
 */
class InputBinding extends internal_1.Saveable {
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'InputBinding'", __errors);
            }
...
InputBinding.attr = new Set(['loadContents']);
