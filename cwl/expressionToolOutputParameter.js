...
exports.ExpressionToolOutputParameter = void 0;
const internal_1 = require("./util/internal");
const uuid_1 = require("uuid");
/**
 * Auto-generated class implementation for https://w3id.org/cwl/cwl#ExpressionToolOutputParameter
 */
class ExpressionToolOutputParameter extends internal_1.Saveable {
    ...
    /**
     * Used to construct instances of {@link ExpressionToolOutputParameter }.
     *
     * @param __doc                           Document fragment to load this record object from.
     * @param baseuri                         Base URI to generate child document IDs against.
     * @param loadingOptions                  Context for loading URIs and populating objects.
     * @param docRoot                         ID at this position in the document (if available)
     * @returns                               An instance of {@link ExpressionToolOutputParameter }
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const [key, value] of Object.entries(_doc)) {
                if (!ExpressionToolOutputParameter.attr.has(key)) {
                    if (key.includes(':')) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'ExpressionToolOutputParameter'", __errors);
            }
...
exports.ExpressionToolOutputParameter = ExpressionToolOutputParameter;
ExpressionToolOutputParameter.attr = new Set(['label', 'secondaryFiles', 'streamable', 'doc', 'id', 'format', 'type']);
//# sourceMappingURL=expressionToolOutputParameter.js.map