...
exports.OperationInputParameter = void 0;
 ...
 *
 */
class OperationInputParameter extends internal_1.Saveable {
    constructor({ extensionFields, loadingOptions, id, label, secondaryFiles, streamable, doc, format, loadContents, loadListing, default_, type }) {
        super();
    ...
    /**
     * Used to construct instances of {@link OperationInputParameter }.
     *
     * @param __doc                           Document fragment to load this record object from.
     * @param baseuri                         Base URI to generate child document IDs against.
     * @param loadingOptions                  Context for loading URIs and populating objects.
     * @param docRoot                         ID at this position in the document (if available)
     * @returns                               An instance of {@link OperationInputParameter }
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const [key, value] of Object.entries(_doc)) {
                if (!OperationInputParameter.attr.has(key)) {
                    if (key.includes(':')) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'OperationInputParameter'", __errors);
            }
            const schema = new OperationInputParameter({
...
exports.OperationInputParameter = OperationInputParameter;
OperationInputParameter.attr = new Set(['label', 'secondaryFiles', 'streamable', 'doc', 'id', 'format', 'loadContents', 'loadListing', 'default', 'type']);
//# sourceMappingURL=operationInputParameter.js.map