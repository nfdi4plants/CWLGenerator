    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'OutputEnumSchema'", __errors);
            }
...
exports.OutputEnumSchema = OutputEnumSchema;
OutputEnumSchema.attr = new Set(['symbols', 'type', 'label', 'doc', 'name']);
//# sourceMappingURL=outputEnumSchema.js.map