...
exports.CommandInputRecordField = void 0;
const internal_1 = require("./util/internal");
/**
 * Auto-generated class implementation for https://w3id.org/cwl/cwl#CommandInputRecordField
 */
class CommandInputRecordField extends internal_1.Saveable {
    constructor({ extensionFields, loadingOptions, name, doc, type, label, secondaryFiles, streamable, format, loadContents, loadListing, inputBinding }) {
        super();
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let type;
            try {
                type = yield (0, internal_1.loadField)(_doc.type, internal_1.LoaderInstances., baseuri, loadingOptions);
            }
            catch (e) {
                if (e instanceof internal_1.ValidationException) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'CommandInputRecordField'", __errors);
            }
...
exports.CommandInputRecordField = CommandInputRecordField;
CommandInputRecordField.attr = new Set(['doc', 'name', 'type', 'label', 'secondaryFiles', 'streamable', 'format', 'loadContents', 'loadListing', 'inputBinding']);
//# sourceMappingURL=commandInputRecordField.js.map