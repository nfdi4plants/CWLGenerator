...
exports.MultipleInputFeatureRequirement = void 0;
 ...
 *
 */
class MultipleInputFeatureRequirement extends internal_1.Saveable {
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let class_;
            try {
                class_ = yield (0, internal_1.loadField)(_doc.class, internal_1.LoaderInstances.uriMultipleInputFeatureRequirement_classLoaderFalseTrueNone, baseuri, loadingOptions);
            }
            catch (e) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'MultipleInputFeatureRequirement'", __errors);
            }
...
exports.MultipleInputFeatureRequirement = MultipleInputFeatureRequirement;
MultipleInputFeatureRequirement.attr = new Set(['class']);
//# sourceMappingURL=multipleInputFeatureRequirement.js.map