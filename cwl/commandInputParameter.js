...
exports.CommandInputParameter = void 0;
 ...
 */
class CommandInputParameter extends internal_1.Saveable {
    constructor({ extensionFields, loadingOptions, id, label, secondaryFiles, streamable, doc, format, loadContents, loadListing, default_, type, inputBinding }) {
        super();
    ...
    /**
     * Used to construct instances of {@link CommandInputParameter }.
     *
     * @param __doc                           Document fragment to load this record object from.
     * @param baseuri                         Base URI to generate child document IDs against.
     * @param loadingOptions                  Context for loading URIs and populating objects.
     * @param docRoot                         ID at this position in the document (if available)
     * @returns                               An instance of {@link CommandInputParameter }
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let type;
            try {
                type = yield (0, internal_1.loadField)(_doc.type, internal_1.LoaderInstances., baseuri, loadingOptions);
            }
            catch (e) {
                if (e instanceof internal_1.ValidationException) {
            ...
            for (const [key, value] of Object.entries(_doc)) {
                if (!CommandInputParameter.attr.has(key)) {
                    if (key.includes(':')) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'CommandInputParameter'", __errors);
            }
    ...
    save(top = false, baseUrl = '', relativeUris = true) {
        ...
        if (this.inputBinding != null) {
            r.inputBinding = (0, internal_1.save)(this.inputBinding, false, this.id, relativeUris);
        }
        if (top) {
...
exports.CommandInputParameter = CommandInputParameter;
CommandInputParameter.attr = new Set(['label', 'secondaryFiles', 'streamable', 'doc', 'id', 'format', 'loadContents', 'loadListing', 'default', 'type', 'inputBinding']);
//# sourceMappingURL=commandInputParameter.js.map