...
exports.CommandInputRecordSchema = void 0;
const internal_1 = require("./util/internal");
const uuid_1 = require("uuid");
/**
 * Auto-generated class implementation for https://w3id.org/cwl/cwl#CommandInputRecordSchema
 */
class CommandInputRecordSchema extends internal_1.Saveable {
    constructor({ extensionFields, loadingOptions, name, fields, type, label, doc, inputBinding }) {
        super();
    ...
    static fromDoc(__doc, baseuri, loadingOptions, docRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ('fields' in _doc) {
                try {
                    fields = yield (0, internal_1.loadField)(_doc.fields, internal_1.LoaderInstances.idmapfieldsunionOfundefinedtypeOrarrayOfCommandInputRecordFieldLoader, baseuri, loadingOptions);
                }
                catch (e) {
                    if (e instanceof internal_1.ValidationException) {
            ...
            if (__errors.length > 0) {
                throw new internal_1.ValidationException("Trying 'CommandInputRecordSchema'", __errors);
            }
...
exports.CommandInputRecordSchema = CommandInputRecordSchema;
CommandInputRecordSchema.attr = new Set(['fields', 'type', 'label', 'doc', 'name', 'inputBinding']);
//# sourceMappingURL=commandInputRecordSchema.js.map